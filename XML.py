...
# Define a function to write the scan results to a XML file.
def writeToXML(portscan_variable):

    # Creating XML object layout.
    ...
    # Create a separate function to fill XML object with the scanned ports.
